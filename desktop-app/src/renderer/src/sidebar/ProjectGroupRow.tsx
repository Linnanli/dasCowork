  ...
  return (
    <div className="min-w-0 space-y-0.5">
      ...
      >
        ...
        <button
          className="pointer-events-none grid size-6 shrink-0 place-items-center rounded-md text-destructive opacity-0 transition group-hover:pointer-events-auto group-hover:opacity-100 group-focus-within:pointer-events-auto group-focus-within:opacity-100 hover:bg-destructive/10 focus-visible:pointer-events-auto focus-visible:opacity-100"
          type="button"
